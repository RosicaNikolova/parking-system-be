package org.onlydevs.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(org.onlydevs.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(org.onlydevs.security.isauthenticated.IsAuthenticated))")
